...
?>
<div class="article">
    <h2 class="title">Detail informations about GDC Conference.</h2>
    <p>
        ...
        IGF is managed and developed by UBM TechWeb, the organizer of the GDC.<br><br>

        <img src="images/img2.jpg" alt="Some photo."><br><br>
        ...
        awards show produced by UBM TechWeb, typically on the Wednesday of the GDC.<br><br>

        <img src="images/img3.jpg" alt="Some photo."><br><br>
